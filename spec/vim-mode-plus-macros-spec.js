...
describe("VimModePlusMacros", () => {
  ...
  describe("when the vim-mode-plus-macros:toggle event is triggered", () => {
    it("hides and shows the modal panel", () => {
      ...
      // has been created
      expect(
        workspaceElement.querySelector(".vim-mode-plus-macros")
      ).not.toExist();
      ...
      runs(() => {
        ...
        let vimModePlusMacrosElement = workspaceElement.querySelector(
          ".vim-mode-plus-macros"
        );
        expect(vimModePlusMacrosElement).toExist();

        let vimModePlusMacrosPanel = atom.workspace.panelForItem(
          vimModePlusMacrosElement
        );
